...
//           <button className="bg-[#ab8235] p-2 md:p-4 flex items-center justify-center flex-shrink-0">
//             <Image src={searchSVG} alt="search" width={24} height={24} />
//           </button>
      ...
      <div className="flex-1 flex flex-col justify-center bg-[#1E1E1E] p-8 md:p-12 gap-8 rounded-[24px] w-full">
        ...
        <div className="flex items-center bg-gray-900 rounded-full overflow-hidden max-w-lg w-full shadow-md">
          ...
          <input
            type="text"
            placeholder="Search for the city, community"
            className="bg-transparent flex-1 p-2 md:p-4 text-white placeholder-gray-400 outline-none text-sm md:text-base"
            style={{ minWidth: "50px" }} 
          />

          <button className="bg-[#ab8235] p-[0.75rem] md:p-4 flex items-center justify-center flex-shrink-0">
