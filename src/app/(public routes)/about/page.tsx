...
export default function AboutUs() {
  return (
    <div className="bg-black min-h-screen">
      ...
      {/* Vision section */}
      <section className="relative flex flex-col md:flex-row items-center   rounded-[24px]  overflow-hidden   w-10/12 mx-auto">
      ...
      <section className=" pt-10 relative flex flex-col md:flex-row items-center   rounded-[24px]  overflow-hidden mt-16 w-10/12 mx-auto">
        ...
        <div className="w-full md:w-1/2 p-8 text-white">
          ...
          <p className="text-lg">
          At Marhaba Estates, our mission is to provide personalized,
          professional, and reliable real estate services. We are
          dedicated to guiding our clients through every step of their
          property journey, ensuring their needs are met with integrity,
          transparency, and expertise. Our commitment is to help clients
          find homes that reflect their dreams, while fostering lasting
